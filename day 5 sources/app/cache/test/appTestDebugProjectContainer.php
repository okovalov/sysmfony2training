...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:\\wamp\\www\\Symfony\\app/cache/test/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:\\wamp\\www\\Symfony\\app/cache/test/assetic/config'), true)));
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinTrainingBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/ManwinTrainingBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinTrainingBundle', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\TrainingBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCustomerBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/ManwinCustomerBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCustomerBundle', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CustomerBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCacheBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/ManwinCacheBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCacheBundle', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CacheBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCommentBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/ManwinCommentBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinCommentBundle', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CommentBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinPageBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/ManwinPageBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ManwinPageBundle', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\PageBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'manwin_grp2', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => '', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $a, $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_a7fdbd5e5fde36f83d3a36dbd10c4982');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a7fdbd5e5fde36f83d3a36dbd10c4982');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_a7fdbd5e5fde36f83d3a36dbd10c4982');

        $e = new \Symfony\Bridge\Doctrine\Annotations\IndexedReader($a);

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($e, array(0 => 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CustomerBundle\\Entity', 1 => 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CommentBundle\\Entity'));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($f, 'Manwin\\Bundle\\CustomerBundle\\Entity');
        $g->addDriver($f, 'Manwin\\Bundle\\CommentBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('ManwinCustomerBundle' => 'Manwin\\Bundle\\CustomerBundle\\Entity', 'ManwinCommentBundle' => 'Manwin\\Bundle\\CommentBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:\\wamp\\www\\Symfony\\app/cache/test/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'manwin.password_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Manwin\Bundle\CustomerBundle\Encoder\HashPasswordEncoder A Manwin\Bundle\CustomerBundle\Encoder\HashPasswordEncoder instance.
     */
    protected function getManwin_PasswordEncoderService()
    {
        return $this->services['manwin.password_encoder'] = new \Manwin\Bundle\CustomerBundle\Encoder\HashPasswordEncoder('sha1');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:\\wamp\\www\\Symfony\\app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:C:\\wamp\\www\\Symfony\\app/cache/test/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:\\wamp\\www\\Symfony\\app/config/routing_dev.yml', array('cache_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'apptestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'apptestUrlMatcher'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Manwin\\Bundle\\CustomerBundle\\Entity\\Customer' => $this->get('manwin.password_encoder')));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.customer_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/customer/login$'), 'security.firewall.map.context.customer_module' => $this->get('security.request_matcher.13bb566497ec557c5c120c688b57cc7d0f81ccab4c4f8c9ea0c464a93651b20517853b43'))), $this->get('event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.customer_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_CustomerLoginService()
    {
        return $this->services['security.firewall.map.context.customer_login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }

    /**
     * Gets the 'security.firewall.map.context.customer_module' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Symfony\Bundle\SecurityBundle\Security\FirewallContext A Symfony\Bundle\SecurityBundle\Security\FirewallContext instance.
     */
    protected function getSecurity_Firewall_Map_Context_CustomerModuleService()
    {
        $a = $this->get('security.request_matcher.13bb566497ec557c5c120c688b57cc7d0f81ccab4c4f8c9ea0c464a93651b20517853b43');
        $b = $this->get('monolog.logger.security');
        $c = $this->get('security.context');
        $d = $this->get('security.user.provider.concrete.customers');
        ...
        $i->add($a, array(0 => 'ROLE_USER'), NULL);

        $j = new \Symfony\Component\Security\Http\HttpUtils($f);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($c, $j, '/customer/logout', '/customer/login', NULL);
        $k->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        return $this->services['security.firewall.map.context.customer_module'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(), $b), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($c, array(0 => $d), 'customer_module', $b, $e), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($c, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'customer_module', array('check_path' => '/customer/auth', 'login_path' => '/customer/login', 'default_target_path' => '/customer/account', 'use_forward' => false, 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false, 'failure_path' => NULL, 'failure_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), NULL, NULL, $b, $e), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, $h, $i, $g, $b), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($c, $d, $this->get('security.user_checker'), 'customer_module', $h, $b, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $this->get('security.authentication.trust_resolver'), $j, new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $j, '/customer/login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['session.storage'] = new \Symfony\Component\HttpFoundation\SessionStorage\FilesystemSessionStorage('C:\\wamp\\www\\Symfony\\app/cache/test/sessions', array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:\\wamp\\www\\Symfony\\app');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/test/translations', 'debug' => true), $this->get('session'));

        $instance->setFallbackLocale('en');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.ca.xliff', 'ca', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.cs.xliff', 'cs', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.da.xliff', 'da', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.de.xliff', 'de', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.es.xliff', 'es', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.et.xliff', 'et', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.eu.xliff', 'eu', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.fa.xliff', 'fa', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.fi.xliff', 'fi', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.fr.xliff', 'fr', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.he.xliff', 'he', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.hu.xliff', 'hu', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.id.xliff', 'id', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.it.xliff', 'it', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.ja.xliff', 'ja', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.lb.xliff', 'lb', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.lt.xliff', 'lt', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.mn.xliff', 'mn', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.nl.xliff', 'nl', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.pl.xliff', 'pl', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.pt_BR.xliff', 'pt_BR', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.pt_PT.xliff', 'pt_PT', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.ro.xliff', 'ro', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.ru.xliff', 'ru', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.sk.xliff', 'sk', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.sl.xliff', 'sl', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.sr.xliff', 'sr', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.sv.xliff', 'sv', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.ua.xliff', 'ua', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\vendor\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/translations\\validators.zh_CN.xliff', 'zh_CN', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CustomerBundle/Resources/translations\\messages.fr.xliff', 'fr', 'messages');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\PageBundle/Resources/translations\\about.fr.xliff', 'fr', 'about');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\PageBundle/Resources/translations\\messages.en.xliff', 'en', 'messages');
        $instance->addResource('xliff', 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\PageBundle/Resources/translations\\messages.fr.xliff', 'fr', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => 'C:\\wamp\\www\\Symfony\\app/cache/test/twig', 'charset' => 'UTF-8'));
        ...
        $instance->addExtension(new \Manwin\Bundle\TrainingBundle\Twig\Extension\TextExtension());
        $instance->addExtension($this->get('twig.extension.acme.demo'));
        $instance->addGlobal('my_global', 'bar');
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:\\wamp\\www\\Symfony\\app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['security.authentication.manager'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.customers'), $this->get('security.user_checker'), 'customer_module', $this->get('security.encoder_factory'), true)));
    }
    ...
    /**
     * Gets the 'security.request_matcher.13bb566497ec557c5c120c688b57cc7d0f81ccab4c4f8c9ea0c464a93651b20517853b43' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_RequestMatcher_13bb566497ec557c5c120c688b57cc7d0f81ccab4c4f8c9ea0c464a93651b20517853b43Service()
    {
        return $this->services['security.request_matcher.13bb566497ec557c5c120c688b57cc7d0f81ccab4c4f8c9ea0c464a93651b20517853b43'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/customer');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ALLOWED_TO_SWITCH', 1 => 'ROLE_USER')));
    }

    /**
     * Gets the 'security.user.provider.concrete.customers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_CustomersService()
    {
        return $this->services['security.user.provider.concrete.customers'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine.orm.default_entity_manager'), 'ManwinCustomerBundle:Customer', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:\\wamp\\www\\Symfony\\app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/test',
            ...
            'kernel.bundles' => array(
                ...
                'ManwinTrainingBundle' => 'Manwin\\Bundle\\TrainingBundle\\ManwinTrainingBundle',
                'ManwinCustomerBundle' => 'Manwin\\Bundle\\CustomerBundle\\ManwinCustomerBundle',
                'ManwinCacheBundle' => 'Manwin\\Bundle\\CacheBundle\\ManwinCacheBundle',
                'ManwinCommentBundle' => 'Manwin\\Bundle\\CommentBundle\\ManwinCommentBundle',
                'ManwinPageBundle' => 'Manwin\\Bundle\\PageBundle\\ManwinPageBundle',
            ...
            'manwin.customer.password_encoder.class' => 'Manwin\\Bundle\\CustomerBundle\\Encoder\\HashPasswordEncoder',
            'manwin.customer.password_encoder.algorithm' => 'sha1',
            'database_driver' => 'pdo_mysql',
            'database_host' => 'localhost',
            'database_port' => '',
            'database_name' => 'manwin_grp2',
            'database_user' => 'root',
            'database_password' => '',
            'mailer_transport' => 'gmail',
            'mailer_host' => '',
            'mailer_user' => 'tradakad@gmail.com',
            'mailer_password' => '',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'avatars_dir' => 'C:\\wamp\\www\\Symfony\\app/../web/pictures',
            ...
            'debug.container.dump' => 'C:\\wamp\\www\\Symfony\\app/cache/test/appTestDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'sqlite:C:\\wamp\\www\\Symfony\\app/cache/test/profiler.db',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\wamp\\www\\Symfony\\app/cache/test/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'swiftmailer.transport.smtp.username' => 'tradakad@gmail.com',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/test/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/test/assetic',
            ...
            'manwin_training.twig.text_extension.class' => 'Manwin\\Bundle\\TrainingBundle\\Twig\\Extension\\TextExtension',
