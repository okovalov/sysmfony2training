...
class __TwigTemplate_58f614940538d7f79c490b8c8eb33490 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("customer_update", array("id" => $this->getAttribute($this->getContext($context, 'entity'), "id", array(), "any", false))), "html");
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "ManwinCustomerBundle:Customer:edit.html.twig";
    }
