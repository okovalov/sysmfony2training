...
class __TwigTemplate_36e9186d440fd0b9b64064859d79d283 extends Twig_Template
{
    protected $parent;
    ...
    public function block_toolbar($context, array $blocks = array())
    {
        ...
        ob_start();
        // line 5
        echo "        <img width=\"20\" height=\"28\" alt=\"Mongo\" style=\"border-width: 0; vertical-align: middle; margin-right: 5px;\" src=\"data:image/png;base64,\"/>
    ";
...
";
    ...
    ";
        // line 26
        if ((!$this->getAttribute($this->getContext($context, 'collector'), "queries", array(), "any", false))) {
            // line 27
            echo "        <p>
            <em>Query logging is disabled.</em>
        <p>
    ";
        } elseif ((!$this->getAttribute($this->getContext($context, 'collector'), "querycount", array(), "any", false))) {
            // line 31
            echo "        <p>
            <em>No queries.</em>
        </p>
            ...
            foreach ($context['_seq'] as $context['_key'] => $context['query']) {
                ...
                echo "\">
                    <div>
                        <code>";
                // line 39
                echo twig_escape_filter($this->env, $this->getContext($context, 'query'), "html");
                echo "</code>
                    </div>
                </li>
            ";
