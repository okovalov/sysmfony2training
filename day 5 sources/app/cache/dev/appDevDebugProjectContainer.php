...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineMongoDBBundle', 'C:\\wamp\\www\\Symfony\\app/Resources/DoctrineMongoDBBundle/views', '/^[^.]+\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DoctrineMongoDBBundle', 'C:\\wamp\\www\\Symfony\\vendor\\bundles\\Symfony\\Bundle\\DoctrineMongoDBBundle/Resources/views', '/^[^.]+\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $a = new \Doctrine\ODM\MongoDB\Mapping\Driver\DriverChain();
        $a->addDriver(new \Doctrine\ODM\MongoDB\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\wamp\\www\\Symfony\\src\\Manwin\\Bundle\\CustomerBundle\\Document')), 'Manwin\\Bundle\\CustomerBundle\\Document');

        $this->services['doctrine.odm.mongodb.default_configuration'] = $instance = new \Doctrine\ODM\MongoDB\Configuration();

        $instance->setDocumentNamespaces(array('ManwinCustomerBundle' => 'Manwin\\Bundle\\CustomerBundle\\Document'));
        $instance->setMetadataCacheImpl($this->get('doctrine.odm.mongodb.default_metadata_cache'));
        $instance->setMetadataDriverImpl($a);
        $instance->setProxyDir('C:\\wamp\\www\\Symfony\\app/cache/dev_new/doctrine/odm/mongodb/Proxies');
        $instance->setProxyNamespace('Proxies');
        $instance->setAutoGenerateProxyClasses(false);
        $instance->setHydratorDir('C:\\wamp\\www\\Symfony\\app/cache/dev_new/doctrine/odm/mongodb/Hydrators');
        $instance->setHydratorNamespace('Hydrators');
        $instance->setAutoGenerateHydratorClasses(false);
        $instance->setDefaultDB('manwin2');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $h->setProxyDir('C:\\wamp\\www\\Symfony\\app/cache/dev_new/doctrine/orm/Proxies');
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->setUsername('tradakad@gmail.com');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/dev_new/translations', 'debug' => true), $this->get('session'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine.odm.mongodb.proxy_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/dev_new/doctrine/odm/mongodb/Proxies',
            'doctrine.odm.mongodb.auto_generate_proxy_classes' => false,
            'doctrine.odm.mongodb.hydrator_namespace' => 'Hydrators',
            'doctrine.odm.mongodb.hydrator_dir' => 'C:\\wamp\\www\\Symfony\\app/cache/dev_new/doctrine/odm/mongodb/Hydrators',
