...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // manwin_customer_customermanager_index
        if (0 === strpos($pathinfo, '/customer/man') && preg_match('#^/customer/man(?:/(?P<letter>[^/]+?))?$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  'letter' => 'all',  '_controller' => 'Manwin\\Bundle\\CustomerBundle\\Controller\\CustomerManagerController::indexAction',)), array('_route' => 'manwin_customer_customermanager_index'));
        }
